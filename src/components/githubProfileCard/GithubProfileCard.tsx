...
const GithubProfileCard: FC<GithubProfileCardProps> = ({ prof }) => {
  console.log({ prof });
  if (prof.isHireable) {
    prof.isHireable = "Yes";
  } else {
    prof.isHireable = " No, I'm happy with my current job 😀";
  }
  return (
    <motion.div
        ...
        <div className="row">
          <div className="main-content-profile">
            ...
            <div className="opp-div">
              <span className="desc-prof">
                Open for opportunities: {emoji(prof.isHireable as string)}
              </span>
            </div>
            <SocialMedia />
          </div>
