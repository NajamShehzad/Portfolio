...
export const pinRepos: PinRepos = {
  "totalCount": 6,
  "edges": [
    {
      "node": {
        ...
        "id": "MDEwOlJlcG9zaXRvcnk3NjgwNjc3Ng==",
        "diskUsage": 183,
        "primaryLanguage": {
          "name": "TypeScript",
          "color": "#3178c6",
    ...
    },
    {
      "node": {
        "name": "Apache Echarts",
        "description":
          "Apache ECharts is a powerful, interactive charting and visualization library for browser.",
        "forkCount": "19.7k",
        "stargazers": {
          "totalCount": "63.3K",
          "__typename": "StargazerConnection",
    ...
    },
    {
      "node": {
        ...
        "url": "https://github.com/NajamShehzad/GraphQlBoilerplate",
        "id": "MDEwOlJlcG9zaXRvcnkyMDcxMTc2NTA=",
        "diskUsage": 5,
        "primaryLanguage": {
          "name": "JavaScript",
          "color": "#f1e05a",
